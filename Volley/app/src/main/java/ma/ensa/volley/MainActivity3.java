...
public class MainActivity3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {

    private EditText username, password;
    private Button bnAdd;
    private Toolbar toolbar; // Ajoute cette ligne pour déclarer la Toolbar
    RequestQueue requestQueue;
    String insertUrl = "http://10.0.2.2:8082/api/v1/users";
    ...
    public void onClick(View view) {
        // Ton code de gestion de clic pour ajouter une filière
